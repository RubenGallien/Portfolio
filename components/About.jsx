    ...
    <div id='about' className=" w-full md:h-screen p-2 flex items-center py-16">
      <div className=" max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className=" col-span-2">
          ...
          <p className=" py-2 text-gray-600">
            Je termine actuellement mon BTS SEO option SLAM. Cette formation représente pour moi une réelle opportunité dans la construction de mon projet professionnelle. 
          </p>
          <p className=" py-2 text-gray-600">
          ...
          <p className=" py-4 text-gray-600">
            Vous pouvez regardez mes réalisations professionnelles

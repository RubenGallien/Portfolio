      ...
      <div className=' max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className=' col-span-4'>
          ...
          <p>
            ...
            Le développement de la partie front-office a été confiée à un autre développeur. Le front permet d’accéder à l’accueil du site, de consulter les formations, les playlists. On peut également accéder à une formation ou playlist particulière. Les CGU sont également visionnables. <br />
